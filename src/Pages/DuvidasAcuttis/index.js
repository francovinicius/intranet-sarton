    ...
    return (
        <section className="duvidas">
            ...
            <div className="accordion d-flex flex-column justify-content-center align-items-center" id="accordionExample">
                ...
                <div class="accordion-item accordion-itens">
                    <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button accordion-btn collapsed" data-bs-toggle="collapse"
                ...
                <div class="accordion-item accordion-itens">
                    <h2 class="accordion-header" id="headingFive">
                        <button class="accordion-button accordion-btn collapsed"
                            type="button" data-bs-toggle="collapse"
